                    ...
                    <?php if (!empty($users)) {
                        foreach ($users as $user) {
                            echo '<tr>' .
                                ...
                                '<td>' . $user->email . '</td>' .
                                '<td class="text-center">' . ($user->active ? '<a href="' . admin_url() . 'auth/deactivate/' . $user->id . '" data-toggle="modal" data-target="#myModal2" class="tip"><span class="label label-success"><i class="fa fa-check"></i> ' . lang('active') . '</span></a>' : '<a href="' . admin_url() . 'auth/activate/' . $user->id . '"><span class="label label-danger"><i class="fa fa-times"></i> ' . lang('inactive') . '</span></a>') . '</td>' .
